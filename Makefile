...
SRC = src/main.c src/cli.c src/cgroups.c src/container.c src/logging.c src/namespaces.c src/network.c src/process.c src/rootfs.c src/state.c src/util.c

# Add test source files here.
TEST_SRC = tests/test_util.c tests/test_cli.c tests/test_cli_errors.c tests/test_state.c tests/test_container.c tests/test_process.c tests/test_namespaces.c tests/test_network.c tests/test_rootfs.c tests/test_logging.c tests/test_cgroups_parse.c
